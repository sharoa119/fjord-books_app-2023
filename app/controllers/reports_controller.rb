...
class ReportsController < ApplicationController
  ...
  def create
    ...
    if @report.save_with_mentions(Report.mentioning_report_ids)
  ...
  def update
    if @report.update_with_mentions(report_params, Report.mentioning_report_ids)
  ...
  def destroy
    @report.destroy_with_mentions(Report.mentioning_report_ids)
